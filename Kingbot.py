...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await idk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await adk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
            await edk(functions.channels.JoinChannelRequest(channel="@Lwolfid"))
